...
SECRET_KEY = "django-insecure-pi4u5ovj+$@=636w_j8%562)m*j@g1kt2p1q-k%(b8xek$z8*4"
...
INSTALLED_APPS = [
    ...
    "site_marchand.apps.SiteMarchandConfig",
...
GATEWAY_CREATE_SESSION_URL = (
    "http://localhost:8000/gateway/recevoir_transaction_marchand/"
)
